...
export function XingLuTongPage() {
  return <main className="xlt-page" id="main">
    <section className="xlt-hero" data-header-theme="inverse"><div className="xlt-shell xlt-hero-grid"><div className="xlt-hero-copy"><p className="xlt-product">星路通 <span>FINANCIAL AI WORKSPACE</span></p><h1>让 AI 进入金融专业工作流程</h1><p>将金融产品资料、客户需求、市场信息与风险数据连接到专业 AI 工作流，辅助金融人员更高效地完成产品尽调、分析、配置和风险识别。</p><div className="xlt-actions"><Link className="button button-accent" to="/contact">预约星路通演示 →</Link><a href="#workflow">探索 AI 工作流 ↓</a></div></div><div className="xlt-hero-stage"><WorkspaceUI title="金融任务工作台" /><div className="xlt-inputs"><span>产品资料</span><span>客户需求</span><span>风险数据</span></div><div className="xlt-outputs"><span>报告</span><span>洞察</span><span>提醒</span></div></div></div></section>
