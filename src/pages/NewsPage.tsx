...
const news: Record<NewsCategory, NewsItem[]> = {
  insights: [
    ...
    article('ai-financial-workflow', 'AI 如何进入真实的金融工作流', '围绕产品尽调、资料分析、风险预警和任务协同，观察 AI 在金融业务中的落地方式。', '人工智能 · 专题导读', 'ai', [['从单点问答进入任务流程', '金融业务中的 AI 不应只停留在生成文本，还需要连接资料、权限、任务以及可追溯的业务过程。'], ['专业场景需要专业上下文', '产品尽调、GAP 分析、风险预警和竞品洞察等任务依赖持续更新的资料与明确的判断边界。'], ['人机协作仍是核心', 'AI 可以辅助信息整理和分析，但重要判断、客户沟通与受监管流程仍需要由具备相应职责的人员完成。']], '/assets/finone-ai-news.png'),
