...
export function EnterpriseSolutionPage() {
  return <main className="enterprise-page" id="main">
    <section className="enterprise-hero" data-header-theme="inverse"><div className="enterprise-shell enterprise-hero-grid">
      <div className="enterprise-hero-copy"><p className="enterprise-label">CORPORATE CLIENTS</p><h1>通过独立平台统一管理企业现金、投资与资产</h1><p>将企业开户、资金、现金管理、投资和资产信息连接到统一数字平台，帮助财务团队更清楚、更高效地管理企业资金。</p><div className="enterprise-actions"><Link className="button button-accent" to="/contact">咨询企业资金管理方案 →</Link><Link to="/products/xingqitong">了解星企通 →</Link></div></div>
