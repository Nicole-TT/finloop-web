...
const capabilities = [
  ...
  { title: '让企业真实资产进入数字金融市场', copy: '通过 FinTaaS 连接资产评估、结构设计、代币化发行与存续管理，帮助企业探索真实资产数字化路径。', items: ['真实资产评估', '资产结构设计', '代币化方案', '数字化发行', '资产信息管理', '存续管理'], links: [['FinTaaS', 'https://finlooprwa.com/fintaas/']], kind: 'rwa', core: 'FinTaaS', visual: ['企业真实资产', '资产代币化', '发行与存续管理'] },
...
const plans = [
  ...
  { title: '真实资产代币化企业', copy: '希望盘活企业持有的真实资产，并探索数字化发行与管理。', stack: ['资产评估与结构设计', 'FinTaaS', '代币化发行', '存续管理'] },
];
